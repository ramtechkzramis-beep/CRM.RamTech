-- Адрес компании и ссылка на 2ГИС — чтобы менеджер мог быстро найти
-- клиента на карте, не гуглив название вручную.
alter table clients add column address text;
alter table clients add column dgis_url text;
